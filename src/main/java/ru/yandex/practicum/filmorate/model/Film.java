...
public class Film {
    ...
    public static final String FILM_RELEASE_DATE_MUST_BE_BEFORE_1985 = "Film release date must be before 1985";
    ...
    @ReleaseDateAfter1985(message = FILM_RELEASE_DATE_MUST_BE_BEFORE_1985)
