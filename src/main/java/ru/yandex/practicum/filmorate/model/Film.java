...
public class Film {
    ...
    public static final String FILM_RELEASE_DATE_MUST_BE_AFTER_1895 = "Film release date must be after 1895";
    ...
    @ReleaseDateAfter1895(message = FILM_RELEASE_DATE_MUST_BE_AFTER_1895)
